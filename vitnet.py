...
class ViTNet(nn.Module):
  def __init__(self, chw=(1, 512, 512), n_patches=32):
    # Super constructor
...
class ViTNetBlock(nn.Module):
    def __init__(self, hidden_d, n_heads, mlp_ratio=4):
        super(ViTNetBlock, self).__init__()
...
class ViTNet(nn.Module):
    def __init__(self, chw, n_patches=7, n_blocks=2, hidden_d=8, n_heads=2, out_d=1):
        ...
        self.blocks = nn.ModuleList([ViTNetBlock(hidden_d, n_heads) for _ in range(n_blocks)])
